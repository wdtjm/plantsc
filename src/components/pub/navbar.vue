<template>
    <div class="tbar" :class="{'shadow':isVisable,'barhide':isHide}"  @mouseenter="mousein" @mouseleave="mouseout">
        ...
        <div>
            <nav>
                <ul>
                    ...
                    <li @click="goto('/celltype')">
                        Celltype
                    </li>
                    <li @click="goto('/marker')">
                        Marker
                    </li>
                    <li @click="goto('/search')">
                        Search
                    </li>
                    <li @click="goto('/spatial')">
                        Spatial
                    </li>
                    <li @click="goto('/references')">
                        References
                    </li>
                    <li @click="goto('/download')">
                        Download
                    </li>
                </ul>
            </nav>
        ...
        <el-submenu class="item" index="2">
            ...
            <el-menu-item index="/release">Release</el-menu-item>
